...
if __name__=='__main__':
    ...
    jeep.holeController().writeCharacteristic(0x0e, bytes.fromhex(characteristicL), withResponse=False)
    sleep(1.5)
    ...
    jeep.holeController().writeCharacteristic(0x0e, bytes.fromhex(characteristicR), withResponse=False)
    sleep(1.5)
    print("Trenne Verbindung...")
    jeep.holeController().disconnect()
    print("***Programmende***")
